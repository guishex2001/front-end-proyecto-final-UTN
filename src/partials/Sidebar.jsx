                        ...
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/dashboard/agrega-un-trabajo"
                              className={({ isActive }) =>
                                'block transition duration-150 truncate ' + (isActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200')
                              }
                            >
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Enviar Mail</span>
                  </div>
                </NavLink>
              </li>
